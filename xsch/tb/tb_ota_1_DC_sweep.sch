...
N -100 20 -100 40 {lab=vout}
N -100 40 -100 140 {lab=vout}
N 60 250 100 250 {lab=vout_ol}
N 0 290 0 310 {lab=GND}
N -140 230 -60 230 {lab=vinp}
N 100 250 120 250 {lab=vout_ol}
N -100 270 -60 270 {lab=#net1}
N -100 270 -100 290 {lab=#net1}
N -100 480 -100 500 {lab=GND}
N -100 400 -100 420 {lab=#net1}
N -100 290 -100 400 {lab=#net1}
...
C {devices/lab_wire.sym} -140 230 0 1 {name=p1 sig_type=std_logic lab=vinp}
...
C {devices/vsource.sym} -100 450 0 0 {name=V_IN1 value=0.9 savecurrent=true}
C {devices/gnd.sym} -100 500 0 0 {name=l8 lab=GND}
