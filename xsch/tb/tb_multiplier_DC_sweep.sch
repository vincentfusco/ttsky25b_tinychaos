...
C {devices/vsource.sym} -370 90 0 0 {name=V_IN value=0.91 savecurrent=true}
...
.control
  ...
  *dc V_IN 0 1.8 0.01
  ...
  print (x3.vcvs1_out_a)
  print (x3.vcvs1_out_b)
  print (x3.vcvs1_out_filt_a)
  print (x3.vcvs1_out_filt_b)
  print v(vout)
...
C {behavioral/multiplier.sym} 250 -420 0 0 {name=X3 Ao=1000 VDD=1.8 VSAT=0.25 GBW=100e6 Rout_ol=100}
