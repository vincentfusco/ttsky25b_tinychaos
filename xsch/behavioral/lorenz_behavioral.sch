...
N 510 -700 530 -700 {lab=vx}
N 530 -700 530 -580 {lab=vx}
...
C {behavioral/ota.sym} 480 -440 0 0 {name=X_VX Ao=1000 VDD=\{VDD\} VSAT=0.25 GBW=100e6 Rout_ol=100}
C {behavioral/multiplier.sym} -40 320 0 0 {name=X_MULT2 VDD=\{VDD\} VSAT=0.25 BW=10e6 GAIN=\{100*scale\}}
...
C {behavioral/ota.sym} 480 -60 0 0 {name=X_VYN Ao=1000 VDD=\{VDD\} VSAT=0.25 GBW=100e6 Rout_ol=100}
...
device=resistor
m=1}
C {behavioral/ota.sym} 460 400 0 0 {name=X_VZ Ao=1000 VDD=\{VDD\} VSAT=0.25 GBW=100e6 Rout_ol=100}
...
C {behavioral/multiplier.sym} -500 -60 0 0 {name=X_MULT1 VDD=\{VDD\} VSAT=0.25 BW=10e6 GAIN=\{100*scale\}}
...
C {devices/vsource.sym} -1720 0 0 0 {name=V3 value=1.8 savecurrent=false}
...
C {devices/code.sym} -1617.5 -555 0 0 {name=SIMULATOR only_toplevel=false value=
"
.option savecurrents
...
.control
  ...
  plot v(vx)-\{VDD/2\} vs v(vz)-\{VDD/2\} retraceplot
